...
import { clear_errors, pharmacy_owner_login_action, register_pharmacy_owner } from '../../Actions/login_action';
...
export const OwnerLogin = () => {
	...
	const loginSubmit = (e) => {
		e.preventDefault();
		dispatch(pharmacy_owner_login_action(loginEmail, loginPassword));
	}

	const registerSubmit = (e) => {
		e.preventDefault();
		dispatch(register_pharmacy_owner(registerName, registerEmail, registerPassword));
	}
		...
		<Fragment>
			{loading ? <Loading /> :
				<div className="login-register">
					...
					<MetaData title="Pharmacy Owner Login..." />
